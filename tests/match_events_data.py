...
pin_data_football = [
    ...
    {'team1': 'Nottingham Forest', 'team2': 'Bournemouth',
     ...
     {'team1': 'Arsenal', 'team2': 'Wolverhampton',
      'datetime': datetime.datetime(2024, 8, 18, 0, 0),
...
book2_data_football = [
    {'name': 'Man United v Fulham', 'team1': 'Manchester United',
...
football_return = [
    {'name': 'Man United v Fulham', 'outcome': 'Manchester United', 'odds': 1.5, 'value': 0.006711409395973256},
    {'name': 'Man United v Fulham', 'outcome': 'draw', 'odds': 4.5, 'value': 0.006711409395973256},
    {'name': 'Ipswich v Liverpool', 'outcome': 'Ipswich Town', 'odds': 8.0, 'value': 0.1049723756906078},
...
book2_data_nrl = [
    {'name': 'South v Melbourne', 'team1': 'South Sydney Rabbitohs', 'team2': 'Melbourne Storm',
     'datetime': datetime.datetime(2024, 8, 8, 19, 50), 'team1_odds': 5.5,
     'team2_odds': 1.15},
    {'name': 'Gold Coast v Cronulla', 'team1': 'Gold Coast Titans', 'team2': 'Cronulla Sharks',
     'datetime': datetime.datetime(2024, 8, 9, 18, 0), 'team1_odds': 1.55,
     'team2_odds': 2.45},
    {'name': 'Parramatta v Penrith', 'team1': 'Parramatta Eels', 'team2': 'Penrith Panthers',
     'datetime': datetime.datetime(2024, 8, 9, 20, 0), 'team1_odds': 6.0, 'team2_odds': 1.13},
    {'name': 'Canberra v Manly', 'team1': 'Canberra Raiders', 'team2': 'Manly Sea Eagles',
     'datetime': datetime.datetime(2024, 8, 10, 15, 0), 'team1_odds': 2.3, 'team2_odds': 1.62}
]

nrl_return = [
    {'name': 'South v Melbourne', 'outcome': 'South Sydney Rabbitohs', 'odds': 5.5, 'value': 0.21145374449339216},
    {'name': 'Gold Coast v Cronulla', 'outcome': 'Cronulla Sharks', 'odds': 2.45, 'value': 0.008230452674897082},
    {'name': 'Parramatta v Penrith', 'outcome': 'Parramatta Eels', 'odds': 6.0, 'value': 0.2847965738758029},
    {'name': 'Canberra v Manly', 'outcome': 'Canberra Raiders', 'odds': 2.3, 'value': 0.03139013452914785}
]
